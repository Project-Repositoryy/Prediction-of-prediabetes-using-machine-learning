...
public class random extends AppCompatActivity {
    ...
    public void btn_checkresult(View view) {
        ...
        if(low.isChecked()) {
            tv4.setText("According to research and study \n Your blood your blood glucose level is within normal limit and you don't have diabetes at present");
            ...
            tv4.setText("According to research and study \n You have higher level of random blood glucosewhich indicates that the possibility for you to have diabetes is more consult your doctor and start the treatment at the earliest");
